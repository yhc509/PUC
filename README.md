...
- **Patch and overwrite rollback:** Scene/prefab patch and asset overwrite flows create same-folder hidden `.bridge-bak` backups for the asset body and `.meta` before mutating files.
